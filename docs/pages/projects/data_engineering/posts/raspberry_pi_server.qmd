...
3. [Linux Server Basics](@sec-linux)
...
4. [Networking Basics](@sec-network)
   ...
   - [Computer Networking Fundamentals](@sec-network_fundamentals)
...
5. [SSH (Secure Shell)](@sec-ssh)
   ...
   - [Understanding SSH Configuration](@sec-ssh_config)
...
7. [Backups and Basic Automation](@sec-backups)
   ...
   - [Setting Up the Backup Directory](@sec-backups_directory)
...
### Fundamental Concepts of Computer Networking {#sec-network_fundamentals}
...
### Understanding SSH Configuration Files {#sec-ssh_configs}
